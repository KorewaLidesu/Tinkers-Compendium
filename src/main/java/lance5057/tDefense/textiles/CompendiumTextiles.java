...
public class CompendiumTextiles {
    ...
    public void preInit() {
        ...
        TCBlocks.registerBlock(roughspunRoof, "roughspunblockroof");

        roughspunItemRoof = TCItems.registerItemBlock("roughspunitemblockroof", roughspunRoof,
    ...
    public void registerItems(RegistryEvent.Register<Item> event) {
        ...
        register.register(roughspunCord);
        ...
        register.register(cottonItemBlock);
    ...
    public void registerBlocks(RegistryEvent.Register<Block> event) {
        ...
        register.register(cottonBlock);
        register.register(cottonCrop);
