...
//				((ArmorCore) armor.getItem()).getEquipmentSlot(), null);
        ...
        GlStateManager.rotate(((float) Math.atan(mouseX / 40.0F)) * 120.0F, 0.0F, 1.0F, 0.0F);
        float t = (float) Math.atan(mouseX / 40.0F) * 20.0F;
        float t2 = (float) Math.atan(mouseX / 40.0F) * 40.0F;
