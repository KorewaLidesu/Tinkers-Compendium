        ...
        if (player.getAir() <= 5) {
            for (int i = 0; i < player.inventory.getSizeInventory(); i++) {
                if (player.inventory.getStackInSlot(i) != null
                    ...
                    world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, player.posX + world.rand.nextDouble() - 0.5f, player.posY + 2 + world.rand.nextDouble() - 0.5f, player.posZ + world.rand.nextDouble() - 0.5f, 0, 1, 0);
                    world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, player.posX + world.rand.nextDouble() - 0.5f, player.posY + 2 + world.rand.nextDouble() - 0.5f, player.posZ + world.rand.nextDouble() - 0.5f, 0, 1, 0);
                    world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, player.posX + world.rand.nextDouble() - 0.5f, player.posY + 2 + world.rand.nextDouble() - 0.5f, player.posZ + world.rand.nextDouble() - 0.5f, 0, 1, 0);
                    world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, player.posX + world.rand.nextDouble() - 0.5f, player.posY + 2 + world.rand.nextDouble() - 0.5f, player.posZ + world.rand.nextDouble() - 0.5f, 0, 1, 0);
                    world.spawnParticle(EnumParticleTypes.WATER_BUBBLE, player.posX + world.rand.nextDouble() - 0.5f, player.posY + 2 + world.rand.nextDouble() - 0.5f, player.posZ + world.rand.nextDouble() - 0.5f, 0, 1, 0);
