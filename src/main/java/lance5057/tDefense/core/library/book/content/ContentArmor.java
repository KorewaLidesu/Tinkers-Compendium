...
public class ContentArmor extends TinkerPage {
    ...
    public static final String ID = "td_armor";

    public static final int TEX_SIZE = 256;
    public static final ImageData IMG_SLOTS = new ImageData(ClientProxy.BOOK_MODIFY, 0, 0, 72, 72, TEX_SIZE, TEX_SIZE);
    public static final ImageData IMG_SLOT_1 = ContentModifier.IMG_SLOT_1;
    public static final ImageData IMG_TABLE = ContentModifier.IMG_TABLE;
