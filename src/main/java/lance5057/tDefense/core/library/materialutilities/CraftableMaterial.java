...
public class CraftableMaterial implements MaterialBase {
    ...
    public void setupInit(MaterialHelper mat) {
        ...
        if (ingot != null)
            mat.mat.addItem(type + StringUtils.capitalize(mat.mat.identifier), 1, Material.VALUE_Ingot);
        if (nugget != null)
            mat.mat.addItem("nugget" + StringUtils.capitalize(mat.mat.identifier), 1, Material.VALUE_Nugget);
        if (block != null)
            mat.mat.addItem("block" + StringUtils.capitalize(mat.mat.identifier), 1, Material.VALUE_Block);

        if (oreDict != null)
            mat.mat.addItem(oreDict, 1, Material.VALUE_Ingot);
    }
