...
public class ComponentTrapDoor extends Block {
    ...
    public static final PropertyEnum<ComponentTrapDoor.DoorHalf> HALF = PropertyEnum.create("half", ComponentTrapDoor.DoorHalf.class);
    ...
    public BlockFaceShape getBlockFaceShape(IBlockAccess worldIn, IBlockState state, BlockPos pos, EnumFacing face) {
        return (face == EnumFacing.UP && state.getValue(HALF) == ComponentTrapDoor.DoorHalf.TOP || face == EnumFacing.DOWN && state.getValue(HALF) == ComponentTrapDoor.DoorHalf.BOTTOM) && !state.getValue(OPEN).booleanValue() ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
    }
