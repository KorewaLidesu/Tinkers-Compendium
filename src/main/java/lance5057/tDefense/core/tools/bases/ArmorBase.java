...
public abstract class ArmorBase extends ItemArmor implements ITinkerable, IModifyable, IRepairable, ISpecialArmor {
    private static final ArmorMaterial base = EnumHelper.addArmorMaterial("tcarmor", "", 0, new int[]{0, 0, 0, 0}, 0, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0);
     ...
     *
     * @param stacks Items to build with. Have to be in the correct order and have
